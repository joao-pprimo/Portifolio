...
def formatar_datas(df, colunas_datas):
...
# Listar as colunas que contêm datas
colunas_datas = ['DT_DEMISSAO', 'ADMISSAO', 'DT_NASCTO']  # Adicione outras colunas de data se necessário

# Formatar datas na planilha base e nova planilha
base_df = formatar_datas(base_df, colunas_datas)
